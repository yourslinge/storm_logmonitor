 ...
 * @author linge E-mail:
 * @version 
 * Created on 2017年4月15日 上午10:52:16
 */
public class MailInfo {
    ...
    private String fromUserName = "日志监控平台"; // 邮件发送者的名称，显示在他人邮件的发件人，注意与邮件发送者地址的区别
    ...
    public MailInfo(String title,String content,List<String> receiver,List<String> ccList){
    	...
    	this.toAddress = list2StringFormat(receiver);
    	this.ccAddress = ccList==null?"":list2StringFormat(ccList);
    	this.mailSubject = title;
    	this.mailContent = content;
    }
    
    private synchronized String list2StringFormat(List<String> list){
